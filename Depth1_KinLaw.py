...
def depthKineticLaw(kinlaw, exp, sbml_file, iReact):
    ...
    # for more then one in depth call, kinlaw is a list instead of an integer
    try:
        kinlaw[0]
        kinlaw = kinlaw[0]
    except:
    ...
    # 1 && 5
        ...
        try:
            ...
            if num_par != 0:
                ...
                for iPar in range(0, num_par):
                    all_parameters.append(sbml_file.getModel().getParameter(iPar).getId() + ' ')
                for iPar in range(0, len(all_parameters)):
                    if exp == all_parameters[iPar]:
                        if int(sbml_file.getModel().getParameter(iPar).getValue()) == sbml_file.getModel().getParameter(iPar).getValue():
                            exp = str(int(sbml_file.getModel().getParameter(iPar).getValue())) + ' '
                            break
                        else:
                            exp = str(sbml_file.getModel().getParameter(iPar).getValue()) + ' '
                            break
        ...
        try:
            ...
            if num_par != 0:
                ...
                for iPar in range(0, len(all_parameters)):
                    if exp == all_parameters[iPar]:
                        if int(sbml_file.getModel().getReaction(iReact).getKineticLaw().getParameter(
                                iPar).getValue()) == sbml_file.getModel().getReaction(
                                iReact).getKineticLaw().getParameter(iPar).getValue():
                            exp = str(int(sbml_file.getModel().getReaction(iReact).getKineticLaw().getParameter(
                                iPar).getValue())) + ' '
                            break
                        else:
            ...
            if num_par != 0:
                ...
                for iPar in range(0, len(all_parameters)):
                    if exp == all_parameters[iPar]:
                        if int(sbml_file.getModel().getReaction(iReact).getKineticLaw().getParameter(
                                iPar).getValue()) == sbml_file.getModel().getReaction(
                            iReact).getKineticLaw().getParameter(
                            iPar).getValue():
                            exp = str(int(sbml_file.getModel().getReaction(iReact).getKineticLaw().getParameter(
                                iPar).getValue())) + ' '
                            break
                ...
                for iPar in range(0, len(all_parameters)):
                    if exp == all_parameters[iPar]:
                        if int(sbml_file.getModel().getParameter(iPar).getValue()) == sbml_file.getModel().getParameter(
                                iPar).getValue():
                            exp = str(int(sbml_file.getModel().getParameter(iPar).getValue())) + ' '
                            break
                        else:
