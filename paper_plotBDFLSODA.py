...
print('bdf_zero_x_smallest: ' + str(sorted(bdf_zero_x)[0]))
print('bdf_zero_y_smallest: ' + str(sorted(bdf_zero_y)[0]))
...
print('bdf_zero_x_largest: ' + str(sorted(bdf_zero_x, reverse=True)[0]))
print('bdf_zero_y_largest: ' + str(sorted(bdf_zero_y, reverse=True)[0]))
