...
def compStaTraj_BioModels():
    ...
    atol = 1e-14    #1e-1 #1e-3  #1e-6  #1e-12  #1e-6  #1e-14  #1e-16                  # 1e-16
    rtol = 1e-14    #1e-1 #1e-3  #1e-6  #1e-12  #1e-3  #1e-14  #1e-16                  # 1e-8
    linSol = 9
    solAlg = 2                                                                                                              # 1

    # split atol an rtol
    _, save_atol = str(atol).split('-')
    _, save_rtol = str(atol).split('-')
